 ...
 * </pre>
 */
@Route(path = "/main/chargingfee")
public class ChargingfeeActivity extends LvBaseAppCompatActivity implements FeeContract.View{
...
//    private static final String TAG = FeeActivity.class.getSimpleName();
    ...
    public static void navigation(String stationId,String stationName){
        ARouter.getInstance().build("/main/chargingfee")
